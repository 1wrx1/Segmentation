...
Updated: 2021.06.10
New features:
(1) Add support to new loss functions
"""
import torch
...
__all__ = ['TverskyLoss', 'FocalTverskyLoss', 'DiceLoss', 'Focal_DiceLoss', 'WBCE_DiceLoss',
           'WBCEWithLogitLoss', 'FocalLoss']


class TverskyLoss(nn.Module):
    def __init__(self, alpha=0.3, beta=0.7, reduction='mean'):
        """
        Tversky loss function for image segmentation using 3D fully convolutional deep networks (arXiv:1706.05721)
        """
...
class FocalTverskyLoss(nn.Module):
    """
    A Novel Focal Tversky loss function with improved Attention U-Net for lesion segmentation (arXiv:1810.07842)
    """
...
class Focal_DiceLoss(nn.Module):
    """
    combination of Focal Loss and Binary Dice Loss
    """
